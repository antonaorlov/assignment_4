/******************************************************************************
 * Title          : TestInsertAndSearch.cpp
 * Author         : Renat Khalikov
 * Created on     : April 27, 2017
 * Description    : main for part 1 of Assignment 4. Be able to insert a file
 *                  of ints, and search specific key (not only minimum) in 
 *                  priority queue
 * Purpose        : to test find functioality
 * Usage          : make search5, make search20, make search100,
 *                  make search1000, make search10000
 * Build with     : make all
 */
